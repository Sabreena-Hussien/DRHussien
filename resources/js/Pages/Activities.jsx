...
const Activities = ({ activities }) => {
    ...
    //     summary: "تماهيا مع حاجات ومتطلبات وهموم البلد الاقتصادية والاجتماعية والمعيشية الخطيرة وترجمة لتوجهات الرابطة في المساهمة الإيجابية في تقديم حلول",
    //     content: "تماهيا مع حاجات ومتطلبات وهموم البلد الاقتصادية والاجتماعية والمعيشية الخطيرة وترجمة لتوجهات الرابطة في المساهمة الإيجابية في تقديم حلولتماهيا مع حاجات ومتطلبات وهموم البلد الاقتصادية والاجتماعية والمعيشية الخطيرة وترجمة لتوجهات الرابطة في المساهمة الإيجابية في تقديم حلول",
    // },
    // {
    //     id: 2,
    //     image: image1,
